...
if(isset($_POST['update_distro']))
{
    ...
    $query = "UPDATE distro SET name='$name', ukuran='$ukuran', harga='$harga', stok='$stok', time='$tgl', img='$img' WHERE id='$distro_id' ";
    $query_run = mysqli_query($con, $query);
...
if(isset($_POST['save_distro']))
{
    ...
    $query = "INSERT INTO distro (name,ukuran,harga,stok,time,img) VALUES ('$name','$ukuran','$harga','$stok','$tgl','$img')";
